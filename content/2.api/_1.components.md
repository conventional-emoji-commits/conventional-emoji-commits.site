...
::code-group
   ...
   ::code-preview{label="Preview"}
    ...
    secondary:
      - Open on GitHub →
      - https://github.com/nuxtlabs/docux
    snippet: npx nuxi@latest init docux-app -t nyxb/docux-starter
    ---
    #title
    Document-driven framework
  
    #description
    Docux reconciles content creators and developers by offering to both the best tools to create and scale content-based websites.
    ::
   ::
