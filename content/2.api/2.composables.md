...
Discover the Docux composables to use in your custom Vue components and pages.

## `useDocux()`

`useDocux()`{lang=ts} gives access to docux runtime config, all default values and your custom config from `app.config.ts`
...
::source-link
---
source: "composables/useDocux.ts"
---
::
